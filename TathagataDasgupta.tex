...
\begin{center}
\hspace{0.3mm}
%\noindient\begin{minipage}{0.09\textwidth}% adapt widths of minipages to your needs
%\noindent\indent\begin{minipage}{0.1\linewidth}% adapt widths of minipages to your needs
...
\end{tabularx}
\begin{tabularx}{0.98\linewidth}{>{\raggedleft\scshape}p{2cm}X}
\gray 2012 \tiny{Summer} & \small{\sffamily{Xaptum.com}}\\
\gray Job Title & \small{\sffamily{Developer Intern}}\\
				%&
 				%\begin{itemize}
 				\vspace{-0.6cm} 
 				&\small{\sffamily {Design and implementation of a heterogenous M2M (machine to machine) platform with ACE, RabbitMQ, OSGi, Spring-WS
 				}}\\
 	 			%\end{itemize}
\end{tabularx}
